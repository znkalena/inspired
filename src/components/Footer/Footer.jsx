        ...
        <Container>
            <div className={s.container}>
                ...
                <div className={s.social}>
                    <h2 className={classNames(s.title,s.socialTitle)}>Связаться с нами</h2>
                    <p className={s.socialSubtitle}>Контакты и адреса магазинов</p>
                    <ul className={s.socialList}>
                        <li>
                            <a href='#' className={classNames(s.link,s.socialLinkVK)}>
                        ...
                        <li>
                            <a href='#' className={classNames(s.link,s.socialLinkFB)}>
                            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={s.development}>
                    <ul className={s.developmentList}>
                        ...
                        <li className={s.developmentItem}>
                        Developer: <a className={s.link} href='#'> Alena Znkvch</a>
                        </li>
                    </ul>
                </div>
            </div>
